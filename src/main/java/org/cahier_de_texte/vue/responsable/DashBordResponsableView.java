package org.cahier_de_texte.vue.responsable;
...
public class DashBordResponsableView extends JFrame {
    DashBordChefView dash = new DashBordChefView();

    public void DashBordResponsableView(String nom){

        add(createSideBarPanel() , BorderLayout.WEST);
        add(homePanel() , BorderLayout.CENTER);

        setTitle("Bienvenue M./Mme. " + nom);
        setSize(1200 , 700);
